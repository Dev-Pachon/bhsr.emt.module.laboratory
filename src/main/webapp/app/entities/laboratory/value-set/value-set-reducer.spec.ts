...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './value-set.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VALUESET_LIST actions', async () => {
    ...
    it('dispatches FETCH_VALUESET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_VALUESET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_VALUESET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_VALUESET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_VALUESET actions', async () => {
      const expectedActions = [
        {
