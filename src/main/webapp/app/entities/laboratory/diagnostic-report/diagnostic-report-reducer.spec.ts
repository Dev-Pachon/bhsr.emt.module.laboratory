...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './diagnostic-report.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DIAGNOSTICREPORT_LIST actions', async () => {
    ...
    it('dispatches FETCH_DIAGNOSTICREPORT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DIAGNOSTICREPORT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DIAGNOSTICREPORT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DIAGNOSTICREPORT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DIAGNOSTICREPORT actions', async () => {
      const expectedActions = [
        {
