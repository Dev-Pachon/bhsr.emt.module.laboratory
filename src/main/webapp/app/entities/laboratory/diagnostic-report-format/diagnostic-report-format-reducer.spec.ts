...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DIAGNOSTICREPORTFORMAT_LIST actions', async () => {
    ...
    it('dispatches FETCH_DIAGNOSTICREPORTFORMAT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DIAGNOSTICREPORTFORMAT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DIAGNOSTICREPORTFORMAT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DIAGNOSTICREPORTFORMAT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DIAGNOSTICREPORTFORMAT actions', async () => {
      const expectedActions = [
        {
