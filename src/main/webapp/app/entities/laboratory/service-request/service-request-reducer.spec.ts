...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SERVICEREQUEST_LIST actions', async () => {
    ...
    it('dispatches FETCH_SERVICEREQUEST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SERVICEREQUEST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SERVICEREQUEST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SERVICEREQUEST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SERVICEREQUEST actions', async () => {
      const expectedActions = [
        {
