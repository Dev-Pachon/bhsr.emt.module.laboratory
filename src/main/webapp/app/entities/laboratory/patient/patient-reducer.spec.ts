...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './patient.reducer';
import { EntityState } from 'app/shared/reducers/reducer.utils';
import { IPatient, defaultValue } from 'app/shared/model/laboratory/patient.model';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches CREATE_PATIENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PATIENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PATIENT actions', async () => {
      const expectedActions = [
        {
