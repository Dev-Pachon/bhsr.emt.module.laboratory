...
export const PatientDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="laboratoryApp.laboratoryPatient.delete.question">
        <Translate contentKey="laboratoryApp.laboratoryPatient.delete.question" interpolate={{ id: patientEntity.id }}>
