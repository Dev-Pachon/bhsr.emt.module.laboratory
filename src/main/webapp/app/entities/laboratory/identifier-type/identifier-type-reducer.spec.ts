...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_IDENTIFIERTYPE_LIST actions', async () => {
    ...
    it('dispatches FETCH_IDENTIFIERTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_IDENTIFIERTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_IDENTIFIERTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_IDENTIFIERTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_IDENTIFIERTYPE actions', async () => {
      const expectedActions = [
        {
